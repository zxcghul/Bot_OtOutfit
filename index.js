...
const newKeyboard = new Keyboard().text('Доставка').text('Эскизы').text('Сроки изготовления').row().text('☑️ Оформить заказ ☑️').resized();
...
bot.callbackQuery('Эскизы', async (ctx) => {
    ...
    // await ctx.replyWithPhoto(new InputFile("img/2.jpg"));
})
